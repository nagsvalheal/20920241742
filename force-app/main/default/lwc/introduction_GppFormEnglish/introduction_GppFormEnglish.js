...
import { OMNIDEF } from './introduction_GppFormEnglish_def.js';
import tmpl from './introduction_GppFormEnglish.html';
import tmpl_nds from './introduction_GppFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class introduction_GppFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
